...
void create_rootkey_from_entropy(const char* mnemonics, const char* password, unsigned int password_size, char *root_key[]);
...
cardano_wallet *generate_address(const char *key, unsigned int index, int internal, 
